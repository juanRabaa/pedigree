...
*
*/
$title = get_theme_mod('pedigree-columns-section-1-title', '');
$columns = json_decode(get_theme_mod('pedigree-columns-section-1-content', ''), true);

?>

<div class="sec list" id="list-1-section">
